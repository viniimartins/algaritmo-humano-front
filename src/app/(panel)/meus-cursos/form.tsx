...
import { useCreateCourse } from '@/modules/courses/mutations/create-course'
import { useUpdateCourse } from '@/modules/courses/mutations/update-course'
...
export function FormContainer(props: Props) {
  ...
  function onSubmit(courseData: ICourseFormData) {
    if (!toUpdateModalCourse) {
      handleCreateCourse({ course: courseData })
    }
